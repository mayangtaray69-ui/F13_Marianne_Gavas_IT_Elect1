...
const CommentCard = ({ name, comment, isMe, image }) => (
  ...
  >
    ...
    <Image
      source={
        isMe
          ? require('./assets/p1.jpg') // Justine avatar
          : require('./assets/prof2.jpg') // Maryan avatar
      }
      style={styles.avatar}
    />
...
const App = () => {
  ...
  // ⭐ CHANGED: Justine sends “Maryan? ikaw n sauna?" and then a picture
  const [comments, setComments] = useState([
    { name: 'Justine', text: 'Maryan? ikaw n sauna?' },
    { name: 'Justine', image: require('./assets/prof1.jpg') }, // Justine sends picture
  ]);
  ...
  const handleAddComment = () => {
    ...
    // You (Maryan) send your message here
